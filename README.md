...
O dar start no server e nos processos para desenvolvimento é necessário rodar o comando: `npm start` para Linux e MacOS ou `npm start:win` para Windows.
...
Email: [sscaetite@gmail.com](mailto:sscaetite@gmail.com)
